...
def cryptofees():
    ...
    # _df.loc[_df['name']=='Solana', 'blockchain'] = 'Solana'
    # _df.loc[_df['name']=='Bitcoin', 'blockchain'] = 'Bitcoin'
    # _df.loc[_df['name']=='Avalanche', 'blockchain'] = 'Avalanche'
    # _df.loc[_df['name']=='Osmosis', 'blockchain'] = 'Osmosis'
    # _df.loc[_df['name']=='Cardano', 'blockchain'] = 'Cardano'
    # _df.loc[_df['name']=='Dogecoin', 'blockchain'] = 'Dogecoin'
    # _df.loc[_df['name']=='Ren Protocol', 'blockchain'] = 'Ren Protocol'
    # _df.loc[_df['name']=='Ripple', 'blockchain'] = 'Ripple'
    # _df.loc[_df['name']=='Tezos', 'blockchain'] = 'Tezos'
    # _df.loc[_df['name']=='Zilliqa', 'blockchain'] = 'Zilliqa'
    # _df.loc[_df['name']=='Litecoin', 'blockchain'] = 'Litecoin'
    # _df.loc[_df['name']=='Stellar', 'blockchain'] = 'Stellar'
    # _df.loc[_df['name']=='Bitcoin SV', 'blockchain'] = 'Bitcoin SV'
    # _df['blockchain'].fillna('Other', inplace=True)
...
collapse_content = dbc.Card([dbc.Row([dbc.Col(time_interval_filter),
...
#     html.P('Created by:',
#            className="card-text"),
#     html.A("@tc_madt", href='https://www.twitter.com/tc_madt', target="_blank"),
#     # dbc.CardLink("Created by: @tc_madt", href="https://www.twitter.com/tc_madt"),
#     # html.P('Data source:',
#     #                               className="card-text"),
#     dbc.CardLink("Data Source: Crypto Fees", href="https://www.cryptofees.info"),
# ],
#     # style={'margin-top': 10, 'margin-bottom': 10,
#     #        'margin-right': '25px', 'margin-left': '25px',
#     #        }
